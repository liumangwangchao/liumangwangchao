			...
			init : function() {
				...
				if (this.QVO) {
					try {
						...
						this.QVO.QvodAdUrl = "http://www.livecn.cc/Live/blank.htm";
						this.QVO.QvodTextAdUrl = "http://www.livecn.cc/Live/blank.htm";
						this.QVO.EnableTextAd = false;
						this.QVO.NextWebPage = "http://www.livecn.cc/Live/blank.htm";
						this.QVO.NumLoop = 0;
						this.ready = true;
					} catch (e) {
					}
